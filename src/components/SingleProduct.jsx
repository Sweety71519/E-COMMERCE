...
import { getCart, createCart } from "../store/ActionCreators/CartActionCreator";
import { getWishlist, createWishlist } from "../store/ActionCreators/WishListActionCreator";
...
export default function ProductDetails(props) {
    ...
    function addToCart() {
        var item = allCartStateData?.slice(1).find((x) => x.userid === localStorage.getItem("userid") && x.productid === Number(id))
        if (!item) {
            item = {
    ...
    function addToWishlist() {
        var item = allWishlistStateData?.slice(1).find((x) => x.userid === localStorage.getItem("userid") && x.productid === Number(id))
    ...
    function getAPIData() {
        ...
        if (allProductStateData.length){
            let item = allProductStateData?.slice(1).find((item) => item.id === Number(id))
            if (item)
                setproduct(item)
                            ...
                            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                                <div className="row">
                                    <div className="col-3 d-flex flex-column justify-content-between">
                                        <img src={`/images/${product.pic1}`} height="100px" width="100px" alt="" data-target="#carouselExampleIndicators" data-slide-to="0" className="active" />
                                        <img src={`/images/${product.pic2}`} height="100px" width="100px" alt="" data-target="#carouselExampleIndicators" data-slide-to="1" />
                                        <img src={`/images/${product.pic3}`} height="100px" width="100px" alt="" data-target="#carouselExampleIndicators" data-slide-to="2" />
                                        <img src={`/images/${product.pic4}`} height="100px" width="100px" alt="" data-target="#carouselExampleIndicators" data-slide-to="3" />
                                    </div>
                                    <div className="col-9">
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <img src={`/images/${product.pic1}`} height="450px" className="d-block w-100" alt="..." />
                                            </div>
                                            <div className="carousel-item">
                                                <img src={`/images/${product.pic2}`} height="450px" className="d-block w-100" alt="..." />
                                            </div>
                                            <div className="carousel-item">
                                                <img src={`/images/${product.pic3}`} height="450px" className="d-block w-100" alt="..." />
                                            </div>
                                            <div className="carousel-item">
                                                <img src={`/images/${product.pic4}`} height="450px" className="d-block w-100" alt="..." />
                                            </div>
