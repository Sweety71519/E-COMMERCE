...
export default function Shop() {
    ...
    function postSearch() {
        ...
        setproduct(stateData.slice(1).reverse().filter((item) => item.name.toLocaleLowerCase().includes(searchTerm) || item.maincategory.toLocaleLowerCase().includes(searchTerm) || item.subcategory.toLocaleLowerCase().includes(searchTerm) || item.brand.toLocaleLowerCase().includes(searchTerm) || item.color.toLocaleLowerCase().includes(searchTerm) || item.size.toLocaleLowerCase().includes(searchTerm) || item.description.toLocaleLowerCase().includes(searchTerm)))

    }
    function getSeacrhInput(e) {
                        ...
                        <div className="col-lg-9 col-md-9">
                            <div className=" row mb-3">
                                <div className="col-md-9 btn-group">
                                    <input type="search" name='search' value={search} onChange={getSeacrhInput} placeholder='Enter Category,Subcategory,Brand color,Size etc to Search:' className='form-control'></input>
                                    <button className='btn btn-success' onClick={postSearch}>Search</button>
                                    <div className="col-md-3">
                                        <select name="sortFilter" onChange={applySortFilter} className='form-control'>
