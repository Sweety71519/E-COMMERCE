...
export default function AdminSubcategory() {
  ...
  var stateData = useSelector((state) => state.SubcategoryStateData)
    ...
    <div className="container-fluid my-3">
      <div className="row">
        ...
        <div className="col-md-10">
          <h5 className='bg-primary p-2 rounded text-light text-center'>Subcategory<Link to="/admin-add-subcategory" className='fa fa-plus text-light float-right'></Link></h5>
                ...
                </tr>
                {
                  data.map((item, index) => {
                    return <tr key={index}>
                      <td>{item.id}</td>
                      <td>{item.name}</td>
                      <td><Link to={"/admin-update-subcategory/"+item.id}> <i className='fa fa-edit' title='Edit' /></Link></td>
